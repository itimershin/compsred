...
class CompetencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competence" do
    assert_difference('Competence.count') do
      post competences_url, params: { competence: { author: @competence.author, skillrate: @competence.skillrate, title: @competence.title } }
    end
  ...
  test "should update competence" do
    patch competence_url(@competence), params: { competence: { author: @competence.author, skillrate: @competence.skillrate, title: @competence.title } }
